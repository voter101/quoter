...
class EntryVote extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, ip, possitive', 'required'),
			array('id, possitive', 'numerical', 'integerOnly'=>true),
			array('ip', 'length', 'max'=>48),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, ip, possitive', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'id0' => array(self::BELONGS_TO, 'Entry', 'id'),
		);
	}
